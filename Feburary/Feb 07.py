...
"""
<div><h4>621. Task Scheduler</h4>
    <font color = "Orange">Medium</font>
    <font style = "font-family:courier new;font-size: 16px; "><div>
...
def leastInterval(tasks, n):
        ...
        max_freq = max(freq_val) #getting the max task with maximum freq
        n_max = freq_val.count(max_freq) #Number of task with maximum freq
        #Total Time = either len of tasks or Maximum Frequency * (waiting time + 1) + Number of task with same freq
